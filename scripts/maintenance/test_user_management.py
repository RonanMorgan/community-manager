...
class TestUserManagement(unittest.TestCase):
    ...
    @patch("scripts.maintenance.user_management.remove_inactive_outline_users")
    @patch("scripts.maintenance.user_management.remove_inactive_nocodb_users")
    @patch("scripts.maintenance.user_management.remove_inactive_mattermost_users")
